...
class RandomForestModel:
    ...
    def train(self, data_path: str, target_column: str, test_size: float = 0.2):
        ...
        try:
            ...
            logging.error(f"Erreur pendant l'entraînement du modèle : {e}")
            return {"error": str(e), "status": "failed"}

    def save_results(self, output_path: str = "app/data/resultats/random_forest_results.json"):
    ...
    **kwargs
    ...
    try:
        ...
        return {
            ...
            "visualization_data": X_test,  # np.ndarray
            "predictions": y_pred,
